...
class AttackAgent(ReflexCaptureAgent):
    ...
    def chooseAction(self, gameState):
        ...
        if myState.isPacman():
            ...
            pacmanCounter = 0
            if myOldPos[0] >= 14 and myOldPos[0] <= 17:
                badTile += 1
    ...
    def getFeatures(self, gameState, action):
        ...
        if len(oldFoodList) - len(foodList) == 0:
            if gettableFood < oldGettableFood:
                features['gotCloserToGettableFood'] = oldGettableFood - gettableFood
        ...
        elif closestCapsule < oldClosestCapsule:
